...
/**
 *  \addtogroup configFramework Related with Framework
 *  @{
 *  \brief Miscellanueos and related with Framework (FWK)
 */
...
/**
 *  \addtogroup configSMA Related with state machine applications
 *  @{
 *  \brief Configuration options related to active objects (SMA)
 */
...
/**
 *  \addtogroup configSM State machine
 *  @{
 *  \brief Configuration options related to state machine behaviors
 */
...
/**
 *  \brief
 *  \addtogroup configTRC Related with trace facility
 *  @{
 *  \brief Configuration options related to trace facility (TRC)
 */
...
/**
 *  \addtogroup configQueue Related with event queue module
 *  @{
...
/**
 *  \addtogroup configMP Related with fixed-sized memory block facility
 *  @{
 *  \brief Configuration options related to fixed-sized memory block (MP)
 */
...
/**
 *  \addtogroup configTMR Related with software timer facility
 *  @{
 *  \brief Configuration options related to software timer facility (TMR)
 */
