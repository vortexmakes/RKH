...
/**
 *  \addtogroup configFramework Related to Framework
 *  @{
...
/**
 *  \addtogroup configSMA Related to state machine applications
 *  @{
...
/**
 *  \addtogroup configSM Related to state machine
 *  @{
...
/**
 *  \brief
 *  \addtogroup configTRC Related to trace facility
 *  @{
...
/**
 *  \addtogroup configMP Related to fixed-sized memory block facility
 *  @{
...
/**
 *  \addtogroup configTMR Related to software timer facility
 *  @{
