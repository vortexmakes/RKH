...
#define LED1			KGPIO(A, 11, 0, KGPIO_PDDR_OUT, KGPIO_PDOR_LOW)
#define LED2			KGPIO(A, 28, 0, KGPIO_PDDR_OUT, KGPIO_PDOR_LOW)
#define LED3			KGPIO(A, 29, 0, KGPIO_PDDR_OUT, KGPIO_PDOR_LOW)
#define LED4			KGPIO(A, 10, 0, KGPIO_PDDR_OUT, KGPIO_PDOR_LOW)
