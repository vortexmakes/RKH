...
RKH_CREATE_TRANS_TABLE(smIPT_s0)
    ...
    RKH_TRREG(G, NULL, NULL, &smIPT_s7),
RKH_END_TRANS_TABLE
...
RKH_CREATE_HISTORY_STORAGE(smIPT_s7);
RKH_CREATE_COMP_REGION_STATE(smIPT_s7, smIPT_nS7, smIPT_xS7, RKH_ROOT, 
                             &smIPT_s71, 
                             NULL, RKH_NO_HISTORY, NULL, NULL, NULL, NULL);
RKH_CREATE_TRANS_TABLE(smIPT_s7)
RKH_END_TRANS_TABLE

RKH_CREATE_BASIC_STATE(smIPT_s71, smIPT_nS71, smIPT_xS71, &smIPT_s7, NULL);
RKH_CREATE_TRANS_TABLE(smIPT_s71)
    RKH_TRCOMPLETION(NULL, smIPT_tr4, &smIPT_s72),
RKH_END_TRANS_TABLE

RKH_CREATE_BASIC_STATE(smIPT_s72, smIPT_nS72, smIPT_xS72, &smIPT_s7, NULL);
RKH_CREATE_TRANS_TABLE(smIPT_s72)
RKH_END_TRANS_TABLE
