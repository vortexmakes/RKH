...
static
void
setUpPseudostateConditional(void)
{
    sm_init();
    sm_ntrnact_ignore();
...
setUp(void)
{
    ...
    setUpTransition();
    setUpPseudostateConditional();
    setUpPseudostate();
    setUpInitPseudostate();
}
...
void
test_InitPseudostateTrnToBranchToNestedSimpleState)
{
    UtrzProcessOut *p;
    SmInitialPseudoTest *me = RKH_CAST(SmInitialPseudoTest, 
                                       smInitialPseudoTest);
