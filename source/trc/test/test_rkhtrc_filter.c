...
static void setUp_toolForTest(void);
static void tearDown_toolForTest(void);
...
tearDown(void)
{
    tearDown_toolForTest();
    tearDown_filter();
}

/* =========================== Filter test group =========================== */
static void
setUp_toolForTest(void)
{
}

static void
tearDown_toolForTest(void)
{
}
 ...
 */
void
test_filEventsAreOnAfterInit(void)
{
...
void
test_turnOffMultipleFilEvent(void)
{
    RKH_GM_OFFSET_T offset;
...
void
test_upperAndLowerBoundsFilEvent(void)
{
    bitTbl[0] = 0x01;
...
void
test_setAllEventsFromOneGroup(void)
{
...
void
test_outOfBoundsProducesRuntimeError(void)
{
...
void
test_turnOnOffMultipleGroups(void)
{
    rkh_bittbl_getBitMask_ExpectAndReturn(RKH_TG_MP, maptbl[RKH_TG_MP]);
    rkh_trc_filter_group_(FILTER_OFF, RKH_TG_MP, EUNCHANGE);
...
void
test_turnOffOneGroupChangedItsEventFilters(void)
{
...
void
test_turnOnOffMultipleSymFil(void)
{
    bitTbl[0] = 0x89;
...
void
test_upperAndLowerBoundsSymFil(void)
{
...
void
test_outOfBoundsProducesRuntimeErrorSymFil(void)
{
    rkh_assert_Expect("rkhtrc_filter", 0);
    rkh_assert_IgnoreArg_file();
    rkh_assert_IgnoreArg_line();
