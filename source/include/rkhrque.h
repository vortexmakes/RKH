...
#ifndef __RKHRQUE_H__
#define __RKHRQUE_H__
...
void rkh_rque_init( RKHRQ_T *q, const void **ps, rkhui8_t sched );
...
#define rkh_rque_is_empty( q )								\
				(HUInt)(rkh_rque_get_num((RKHRQ_T*)(q))==0)
...
HUInt rkh_rque_is_full( RKHRQ_T *q );
...
RKH_RQNE_T rkh_rque_get_num( RKHRQ_T *q );
...
RKH_RQNE_T rkh_rque_get_lwm( RKHRQ_T *q );
...
HUInt rkh_rque_get( RKHRQ_T *q, void *pe );
...
void rkh_rque_put_fifo( RKHRQ_T *q, const void *pe );
...
void rkh_rque_put_lifo( RKHRQ_T *q, const void *pe );
...
HUInt rkh_rque_read( RKHRQ_T *q, void *pe ); 
...
void rkh_rque_get_info( RKHRQ_T *q, RKH_RQ_INFO_T *pqi );
...
void rkh_rque_clear_info( RKHRQ_T *q );
