...
#if RKH_CFG_MAX_SMA <= 8
	#define RKH_NUM_RDYGRP		1
#elif RKH_CFG_MAX_SMA > 8 && RKH_CFG_MAX_SMA <= 16
	#define RKH_NUM_RDYGRP		2
#elif RKH_CFG_MAX_SMA > 16 && RKH_CFG_MAX_SMA <= 24
	#define RKH_NUM_RDYGRP		3
#elif RKH_CFG_MAX_SMA > 24 && RKH_CFG_MAX_SMA <= 32
	#define RKH_NUM_RDYGRP		4
#elif RKH_CFG_MAX_SMA > 32 && RKH_CFG_MAX_SMA <= 40
	#define RKH_NUM_RDYGRP		5
#elif RKH_CFG_MAX_SMA > 40 && RKH_CFG_MAX_SMA <= 48
	#define RKH_NUM_RDYGRP		6
#elif RKH_CFG_MAX_SMA > 48 && RKH_CFG_MAX_SMA <= 56
	#define RKH_NUM_RDYGRP		7
#elif RKH_CFG_MAX_SMA > 56 && RKH_CFG_MAX_SMA <= 64
