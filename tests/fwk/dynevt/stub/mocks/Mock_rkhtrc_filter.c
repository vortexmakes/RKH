...
void rkh_trc_filter_group__CMockIgnoreArg_ctrl(UNITY_LINE_TYPE cmock_line)
{
  ...
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "ctrl IgnoreArg called before Expect on 'rkh_trc_filter_group_'.");
...
{
  CMOCK_rkh_trc_filter_group__CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_trc_filter_group__CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.rkh_trc_filter_group__CallInstance));
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "grp IgnoreArg called before Expect on 'rkh_trc_filter_group_'.");
...
{
  CMOCK_rkh_trc_filter_group__CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_trc_filter_group__CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.rkh_trc_filter_group__CallInstance));
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "mode IgnoreArg called before Expect on 'rkh_trc_filter_group_'.");
...
void rkh_trc_filter_event__CMockIgnoreArg_ctrl(UNITY_LINE_TYPE cmock_line)
{
  ...
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "ctrl IgnoreArg called before Expect on 'rkh_trc_filter_event_'.");
  cmock_call_instance->IgnoreArg_ctrl = 1;
}
...
{
  CMOCK_rkh_trc_filter_event__CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_trc_filter_event__CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.rkh_trc_filter_event__CallInstance));
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "evt IgnoreArg called before Expect on 'rkh_trc_filter_event_'.");
...
rbool_t rkh_trc_isoff_(RKH_TE_ID_T e)
{
  ...
  if (Mock.rkh_trc_isoff__CallbackFunctionPointer != NULL)
  {
    return Mock.rkh_trc_isoff__CallbackFunctionPointer(e, Mock.rkh_trc_isoff__CallbackCalls++);
  }
  return cmock_call_instance->ReturnVal;
}
...
void rkh_trc_isoff__CMockIgnoreArg_e(UNITY_LINE_TYPE cmock_line)
{
  ...
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "e IgnoreArg called before Expect on 'rkh_trc_isoff_'.");
...
void rkh_trc_symFil(RKHFilter fd, RKH_TRC_FSLOT slot, rui8_t mode)
{
  ...
  {
    UNITY_TEST_ASSERT_EQUAL_MEMORY((void*)(&cmock_call_instance->Expected_fd), (void*)(&fd), sizeof(RKHFilter), cmock_line, "Function 'rkh_trc_symFil' called with unexpected value for argument 'fd'.");
  }
...
void rkh_trc_symFil_CMockIgnoreArg_fd(UNITY_LINE_TYPE cmock_line)
{
  ...
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "fd IgnoreArg called before Expect on 'rkh_trc_symFil'.");
...
{
  CMOCK_rkh_trc_symFil_CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_trc_symFil_CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.rkh_trc_symFil_CallInstance));
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "slot IgnoreArg called before Expect on 'rkh_trc_symFil'.");
...
{
  CMOCK_rkh_trc_symFil_CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_trc_symFil_CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.rkh_trc_symFil_CallInstance));
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "mode IgnoreArg called before Expect on 'rkh_trc_symFil'.");
  cmock_call_instance->IgnoreArg_mode = 1;
}
...
rbool_t rkh_trc_symFil_isoff(RKHFilter fd, RKH_TRC_FSLOT slot)
{
  ...
  if (!cmock_call_instance->IgnoreArg_fd)
  {
    UNITY_TEST_ASSERT_EQUAL_MEMORY((void*)(&cmock_call_instance->Expected_fd), (void*)(&fd), sizeof(RKHFilter), cmock_line, "Function 'rkh_trc_symFil_isoff' called with unexpected value for argument 'fd'.");
  }
  if (!cmock_call_instance->IgnoreArg_slot)
  {
  ...
  if (Mock.rkh_trc_symFil_isoff_CallbackFunctionPointer != NULL)
  {
    return Mock.rkh_trc_symFil_isoff_CallbackFunctionPointer(fd, slot, Mock.rkh_trc_symFil_isoff_CallbackCalls++);
  }
  return cmock_call_instance->ReturnVal;
}
...
void rkh_trc_symFil_isoff_CMockIgnoreArg_fd(UNITY_LINE_TYPE cmock_line)
{
  ...
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "fd IgnoreArg called before Expect on 'rkh_trc_symFil_isoff'.");
  cmock_call_instance->IgnoreArg_fd = 1;
}
...
{
  CMOCK_rkh_trc_symFil_isoff_CALL_INSTANCE* cmock_call_instance = (CMOCK_rkh_trc_symFil_isoff_CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.rkh_trc_symFil_isoff_CallInstance));
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "slot IgnoreArg called before Expect on 'rkh_trc_symFil_isoff'.");
  cmock_call_instance->IgnoreArg_slot = 1;
}
...
void rkh_trc_filter_get_CMockIgnoreArg_outFilterTbl(UNITY_LINE_TYPE cmock_line)
{
  ...
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "outFilterTbl IgnoreArg called before Expect on 'rkh_trc_filter_get'.");
