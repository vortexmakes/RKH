...
**
**     Abstract:
**         This header file implements peripheral memory map for MK60D10
**         processor.
**
 ...
 * @version 1.6
 * @date 2012-10-29
 * @brief Peripheral memory map for MK60D10
 *
 * This header file implements peripheral memory map for MK60D10 processor.
 */
...
#if !defined(MCU_MK60D10)  /* Check if memory map has not been already included */
#define MCU_MK60D10
...
#define ENET_IEEE_T_REG(base)                ((base)->IEEE_T_DEF)
...
#define ENET_IEEE_T_DEF                          ENET_IEEE_T_REG(ENET_BASE_PTR)
