...
#define LED1			PTC, 0, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
#define LED2			PTC, 1, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
#define LED3			PTC, 2, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
#define LED4			PTC, 3, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
#define LED5			PTC, 4, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
#define LED6			PTC, 5, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
#define LED7			PTE, 6, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
#define LED8			PTE, 7, PIN_DIR_OUT, PIN_PE_DIS, PIN_LOW
