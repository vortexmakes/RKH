...
+ Project organization
	...
	|-[mcu] routines to initialize MCU peripherals, ISR´s and time stamp.
	|-[prj] contains the Blinky CW63 Project, run "blinky.mcp" to start demo.
	|-[serial] routines to handle serial port.
	|-bsp.c board support package source file.
	|-bsp.c board support package header file.
