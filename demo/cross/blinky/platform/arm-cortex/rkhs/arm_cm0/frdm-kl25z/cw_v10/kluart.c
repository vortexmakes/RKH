...
{
	{ UART0_BASE_PTR, IRQ_NUMBER( INT_UART0 ), BSP_UART_IRQ_PRIO, NULL },
	{ UART1_BASE_PTR, IRQ_NUMBER( INT_UART1 ), BSP_UART_IRQ_PRIO, NULL },
	{ UART2_BASE_PTR, IRQ_NUMBER( INT_UART2 ), BSP_UART_IRQ_PRIO, NULL },
	{ NULL}
};
