...
**     Reference manual:    K60P144M100SF2RM, Rev. 1 Draft A, 30 July 2010
...
#define AXBS_MGPCR3_AULB(x)                      (((x)<<AXBS_MGPCR3_AULB_SHIFT)&AXBS_MGPCR3_AULB_MASK)
/* MGPCR4 Bit Fields */
...
#define CAU_CASR_VER(x)                          (((x)<<CAU_CASR_VER_SHIFT)&CAU_CASR_VER_MASK)
/* CAA Bit Fields */
#define CAU_CAA_ACC_MASK                         0xFFFFFFFFu
#define CAU_CAA_ACC_SHIFT                        0
#define CAU_CAA_ACC(x)                           (((x)<<CAU_CAA_ACC_SHIFT)&CAU_CAA_ACC_MASK)
/* CA Bit Fields */
#define CAU_CA_CAn_MASK                          0xFFFFFFFFu
#define CAU_CA_CAn_SHIFT                         0
#define CAU_CA_CAn(x)                            (((x)<<CAU_CA_CAn_SHIFT)&CAU_CA_CAn_MASK)
...
#define ENET_MMFR_DATA(x)                        (((x)<<ENET_MMFR_DATA_SHIFT)&ENET_MMFR_DATA_MASK)
#define ENET_MMFR_TA_MASK                        0x30000u
#define ENET_MMFR_TA_SHIFT                       16
#define ENET_MMFR_TA(x)                          (((x)<<ENET_MMFR_TA_SHIFT)&ENET_MMFR_TA_MASK)
#define ENET_MMFR_RA_MASK                        0x7C0000u
#define ENET_MMFR_RA_SHIFT                       18
#define ENET_MMFR_RA(x)                          (((x)<<ENET_MMFR_RA_SHIFT)&ENET_MMFR_RA_MASK)
#define ENET_MMFR_PA_MASK                        0xF800000u
#define ENET_MMFR_PA_SHIFT                       23
#define ENET_MMFR_PA(x)                          (((x)<<ENET_MMFR_PA_SHIFT)&ENET_MMFR_PA_MASK)
#define ENET_MMFR_OP_MASK                        0x30000000u
#define ENET_MMFR_OP_SHIFT                       28
#define ENET_MMFR_OP(x)                          (((x)<<ENET_MMFR_OP_SHIFT)&ENET_MMFR_OP_MASK)
#define ENET_MMFR_ST_MASK                        0xC0000000u
#define ENET_MMFR_ST_SHIFT                       30
#define ENET_MMFR_ST(x)                          (((x)<<ENET_MMFR_ST_SHIFT)&ENET_MMFR_ST_MASK)
/* MSCR Bit Fields */
#define ENET_MSCR_MII_SPEED_MASK                 0x7Eu
#define ENET_MSCR_MII_SPEED_SHIFT                1
#define ENET_MSCR_MII_SPEED(x)                   (((x)<<ENET_MSCR_MII_SPEED_SHIFT)&ENET_MSCR_MII_SPEED_MASK)
#define ENET_MSCR_DIS_PRE_MASK                   0x80u
#define ENET_MSCR_DIS_PRE_SHIFT                  7
#define ENET_MSCR_HOLDTIME_MASK                  0x700u
#define ENET_MSCR_HOLDTIME_SHIFT                 8
#define ENET_MSCR_HOLDTIME(x)                    (((x)<<ENET_MSCR_HOLDTIME_SHIFT)&ENET_MSCR_HOLDTIME_MASK)
/* MIBC Bit Fields */
...
#define ENET_RCR_MAX_FL(x)                       (((x)<<ENET_RCR_MAX_FL_SHIFT)&ENET_RCR_MAX_FL_MASK)
...
#define ENET_TCR_ADDSEL(x)                       (((x)<<ENET_TCR_ADDSEL_SHIFT)&ENET_TCR_ADDSEL_MASK)
...
#define ENET_PALR_PADDR1(x)                      (((x)<<ENET_PALR_PADDR1_SHIFT)&ENET_PALR_PADDR1_MASK)
/* PAUR Bit Fields */
#define ENET_PAUR_TYPE_MASK                      0xFFFFu
#define ENET_PAUR_TYPE_SHIFT                     0
#define ENET_PAUR_TYPE(x)                        (((x)<<ENET_PAUR_TYPE_SHIFT)&ENET_PAUR_TYPE_MASK)
#define ENET_PAUR_PADDR2_MASK                    0xFFFF0000u
#define ENET_PAUR_PADDR2_SHIFT                   16
#define ENET_PAUR_PADDR2(x)                      (((x)<<ENET_PAUR_PADDR2_SHIFT)&ENET_PAUR_PADDR2_MASK)
/* OPD Bit Fields */
#define ENET_OPD_PAUSE_DUR_MASK                  0xFFFFu
#define ENET_OPD_PAUSE_DUR_SHIFT                 0
#define ENET_OPD_PAUSE_DUR(x)                    (((x)<<ENET_OPD_PAUSE_DUR_SHIFT)&ENET_OPD_PAUSE_DUR_MASK)
#define ENET_OPD_OPCODE_MASK                     0xFFFF0000u
#define ENET_OPD_OPCODE_SHIFT                    16
#define ENET_OPD_OPCODE(x)                       (((x)<<ENET_OPD_OPCODE_SHIFT)&ENET_OPD_OPCODE_MASK)
/* IAUR Bit Fields */
#define ENET_IAUR_IADDR1_MASK                    0xFFFFFFFFu
#define ENET_IAUR_IADDR1_SHIFT                   0
#define ENET_IAUR_IADDR1(x)                      (((x)<<ENET_IAUR_IADDR1_SHIFT)&ENET_IAUR_IADDR1_MASK)
/* IALR Bit Fields */
#define ENET_IALR_IADDR2_MASK                    0xFFFFFFFFu
#define ENET_IALR_IADDR2_SHIFT                   0
#define ENET_IALR_IADDR2(x)                      (((x)<<ENET_IALR_IADDR2_SHIFT)&ENET_IALR_IADDR2_MASK)
/* GAUR Bit Fields */
#define ENET_GAUR_GADDR1_MASK                    0xFFFFFFFFu
#define ENET_GAUR_GADDR1_SHIFT                   0
#define ENET_GAUR_GADDR1(x)                      (((x)<<ENET_GAUR_GADDR1_SHIFT)&ENET_GAUR_GADDR1_MASK)
/* GALR Bit Fields */
#define ENET_GALR_GADDR2_MASK                    0xFFFFFFFFu
#define ENET_GALR_GADDR2_SHIFT                   0
#define ENET_GALR_GADDR2(x)                      (((x)<<ENET_GALR_GADDR2_SHIFT)&ENET_GALR_GADDR2_MASK)
/* TFWR Bit Fields */
#define ENET_TFWR_TFWR_MASK                      0x3Fu
#define ENET_TFWR_TFWR_SHIFT                     0
#define ENET_TFWR_TFWR(x)                        (((x)<<ENET_TFWR_TFWR_SHIFT)&ENET_TFWR_TFWR_MASK)
#define ENET_TFWR_STRFWD_MASK                    0x100u
#define ENET_TFWR_STRFWD_SHIFT                   8
/* RDSR Bit Fields */
#define ENET_RDSR_R_DES_START_MASK               0xFFFFFFF8u
#define ENET_RDSR_R_DES_START_SHIFT              3
#define ENET_RDSR_R_DES_START(x)                 (((x)<<ENET_RDSR_R_DES_START_SHIFT)&ENET_RDSR_R_DES_START_MASK)
/* TDSR Bit Fields */
#define ENET_TDSR_X_DES_START_MASK               0xFFFFFFF8u
#define ENET_TDSR_X_DES_START_SHIFT              3
#define ENET_TDSR_X_DES_START(x)                 (((x)<<ENET_TDSR_X_DES_START_SHIFT)&ENET_TDSR_X_DES_START_MASK)
/* MRBR Bit Fields */
#define ENET_MRBR_R_BUF_SIZE_MASK                0x3FF0u
#define ENET_MRBR_R_BUF_SIZE_SHIFT               4
#define ENET_MRBR_R_BUF_SIZE(x)                  (((x)<<ENET_MRBR_R_BUF_SIZE_SHIFT)&ENET_MRBR_R_BUF_SIZE_MASK)
/* RSFL Bit Fields */
#define ENET_RSFL_RX_SECTION_FULL_MASK           0xFFu
#define ENET_RSFL_RX_SECTION_FULL_SHIFT          0
#define ENET_RSFL_RX_SECTION_FULL(x)             (((x)<<ENET_RSFL_RX_SECTION_FULL_SHIFT)&ENET_RSFL_RX_SECTION_FULL_MASK)
/* RSEM Bit Fields */
#define ENET_RSEM_RX_SECTION_EMPTY_MASK          0xFFu
#define ENET_RSEM_RX_SECTION_EMPTY_SHIFT         0
#define ENET_RSEM_RX_SECTION_EMPTY(x)            (((x)<<ENET_RSEM_RX_SECTION_EMPTY_SHIFT)&ENET_RSEM_RX_SECTION_EMPTY_MASK)
/* RAEM Bit Fields */
#define ENET_RAEM_RX_ALMOST_EMPTY_MASK           0xFFu
#define ENET_RAEM_RX_ALMOST_EMPTY_SHIFT          0
#define ENET_RAEM_RX_ALMOST_EMPTY(x)             (((x)<<ENET_RAEM_RX_ALMOST_EMPTY_SHIFT)&ENET_RAEM_RX_ALMOST_EMPTY_MASK)
/* RAFL Bit Fields */
#define ENET_RAFL_RX_ALMOST_FULL_MASK            0xFFu
#define ENET_RAFL_RX_ALMOST_FULL_SHIFT           0
#define ENET_RAFL_RX_ALMOST_FULL(x)              (((x)<<ENET_RAFL_RX_ALMOST_FULL_SHIFT)&ENET_RAFL_RX_ALMOST_FULL_MASK)
/* TSEM Bit Fields */
#define ENET_TSEM_TX_SECTION_EMPTY_MASK          0xFFu
#define ENET_TSEM_TX_SECTION_EMPTY_SHIFT         0
#define ENET_TSEM_TX_SECTION_EMPTY(x)            (((x)<<ENET_TSEM_TX_SECTION_EMPTY_SHIFT)&ENET_TSEM_TX_SECTION_EMPTY_MASK)
/* TAEM Bit Fields */
#define ENET_TAEM_TX_ALMOST_EMPTY_MASK           0xFFu
#define ENET_TAEM_TX_ALMOST_EMPTY_SHIFT          0
#define ENET_TAEM_TX_ALMOST_EMPTY(x)             (((x)<<ENET_TAEM_TX_ALMOST_EMPTY_SHIFT)&ENET_TAEM_TX_ALMOST_EMPTY_MASK)
/* TAFL Bit Fields */
#define ENET_TAFL_TX_ALMOST_FULL_MASK            0xFFu
#define ENET_TAFL_TX_ALMOST_FULL_SHIFT           0
#define ENET_TAFL_TX_ALMOST_FULL(x)              (((x)<<ENET_TAFL_TX_ALMOST_FULL_SHIFT)&ENET_TAFL_TX_ALMOST_FULL_MASK)
/* TIPG Bit Fields */
#define ENET_TIPG_IPG_MASK                       0x1Fu
#define ENET_TIPG_IPG_SHIFT                      0
#define ENET_TIPG_IPG(x)                         (((x)<<ENET_TIPG_IPG_SHIFT)&ENET_TIPG_IPG_MASK)
/* FTRL Bit Fields */
#define ENET_FTRL_TRUNC_FL_MASK                  0x3FFFu
#define ENET_FTRL_TRUNC_FL_SHIFT                 0
#define ENET_FTRL_TRUNC_FL(x)                    (((x)<<ENET_FTRL_TRUNC_FL_SHIFT)&ENET_FTRL_TRUNC_FL_MASK)
/* TACC Bit Fields */
...
#define ENET_ATVR_ATIME(x)                       (((x)<<ENET_ATVR_ATIME_SHIFT)&ENET_ATVR_ATIME_MASK)
/* ATOFF Bit Fields */
#define ENET_ATOFF_OFFSET_MASK                   0xFFFFFFFFu
#define ENET_ATOFF_OFFSET_SHIFT                  0
#define ENET_ATOFF_OFFSET(x)                     (((x)<<ENET_ATOFF_OFFSET_SHIFT)&ENET_ATOFF_OFFSET_MASK)
/* ATPER Bit Fields */
#define ENET_ATPER_PERIOD_MASK                   0xFFFFFFFFu
#define ENET_ATPER_PERIOD_SHIFT                  0
#define ENET_ATPER_PERIOD(x)                     (((x)<<ENET_ATPER_PERIOD_SHIFT)&ENET_ATPER_PERIOD_MASK)
/* ATCOR Bit Fields */
#define ENET_ATCOR_COR_MASK                      0x7FFFFFFFu
#define ENET_ATCOR_COR_SHIFT                     0
#define ENET_ATCOR_COR(x)                        (((x)<<ENET_ATCOR_COR_SHIFT)&ENET_ATCOR_COR_MASK)
/* ATINC Bit Fields */
#define ENET_ATINC_INC_MASK                      0x7Fu
#define ENET_ATINC_INC_SHIFT                     0
#define ENET_ATINC_INC(x)                        (((x)<<ENET_ATINC_INC_SHIFT)&ENET_ATINC_INC_MASK)
#define ENET_ATINC_INC_CORR_MASK                 0x7F00u
#define ENET_ATINC_INC_CORR_SHIFT                8
#define ENET_ATINC_INC_CORR(x)                   (((x)<<ENET_ATINC_INC_CORR_SHIFT)&ENET_ATINC_INC_CORR_MASK)
/* ATSTMP Bit Fields */
#define ENET_ATSTMP_TIMESTAMP_MASK               0xFFFFFFFFu
#define ENET_ATSTMP_TIMESTAMP_SHIFT              0
#define ENET_ATSTMP_TIMESTAMP(x)                 (((x)<<ENET_ATSTMP_TIMESTAMP_SHIFT)&ENET_ATSTMP_TIMESTAMP_MASK)
/* TGSR Bit Fields */
...
#define ENET_TCSR_TMODE(x)                       (((x)<<ENET_TCSR_TMODE_SHIFT)&ENET_TCSR_TMODE_MASK)
...
#define ENET_TCCR_TCC(x)                         (((x)<<ENET_TCCR_TCC_SHIFT)&ENET_TCCR_TCC_MASK)
...
#define RNG_VER_MINOR(x)                         (((x)<<RNG_VER_MINOR_SHIFT)&RNG_VER_MINOR_MASK)
#define RNG_VER_MAJOR_MASK                       0xFF00u
#define RNG_VER_MAJOR_SHIFT                      8
#define RNG_VER_MAJOR(x)                         (((x)<<RNG_VER_MAJOR_SHIFT)&RNG_VER_MAJOR_MASK)
#define RNG_VER_TYPE_MASK                        0xF0000000u
#define RNG_VER_TYPE_SHIFT                       28
#define RNG_VER_TYPE(x)                          (((x)<<RNG_VER_TYPE_SHIFT)&RNG_VER_TYPE_MASK)
/* CMD Bit Fields */
...
#define RNG_CR_FUFMOD(x)                         (((x)<<RNG_CR_FUFMOD_SHIFT)&RNG_CR_FUFMOD_MASK)
...
#define RNG_SR_FIFO_LVL(x)                       (((x)<<RNG_SR_FIFO_LVL_SHIFT)&RNG_SR_FIFO_LVL_MASK)
#define RNG_SR_FIFO_SIZE_MASK                    0xF000u
#define RNG_SR_FIFO_SIZE_SHIFT                   12
#define RNG_SR_FIFO_SIZE(x)                      (((x)<<RNG_SR_FIFO_SIZE_SHIFT)&RNG_SR_FIFO_SIZE_MASK)
#define RNG_SR_ERR_MASK                          0x10000u
#define RNG_SR_ERR_SHIFT                         16
#define RNG_SR_ST_PF_MASK                        0xE00000u
#define RNG_SR_ST_PF_SHIFT                       21
#define RNG_SR_ST_PF(x)                          (((x)<<RNG_SR_ST_PF_SHIFT)&RNG_SR_ST_PF_MASK)
#define RNG_SR_STATPF_MASK                       0xFF000000u
#define RNG_SR_STATPF_SHIFT                      24
#define RNG_SR_STATPF(x)                         (((x)<<RNG_SR_STATPF_SHIFT)&RNG_SR_STATPF_MASK)
/* ESR Bit Fields */
...
#define RNG_OUT_RANDOUT(x)                       (((x)<<RNG_OUT_RANDOUT_SHIFT)&RNG_OUT_RANDOUT_MASK)

/*! \} */ /* end of group RNG_Register_Masks */


/* RNG - Peripheral instance base addresses */
/*! Peripheral RNGB base pointer */
#define RNGB_BASE_PTR                            ((RNG_MemMapPtr)0x400A0000u)
...
/* RNGB */
#define RNG_VER                                  RNG_VER_REG(RNGB_BASE_PTR)
#define RNG_CMD                                  RNG_CMD_REG(RNGB_BASE_PTR)
#define RNG_CR                                   RNG_CR_REG(RNGB_BASE_PTR)
#define RNG_SR                                   RNG_SR_REG(RNGB_BASE_PTR)
#define RNG_ESR                                  RNG_ESR_REG(RNGB_BASE_PTR)
#define RNG_OUT                                  RNG_OUT_REG(RNGB_BASE_PTR)
...
#define SIM_SOPT2_TIMESRC(x)                     (((x)<<SIM_SOPT2_TIMESRC_SHIFT)&SIM_SOPT2_TIMESRC_MASK)
