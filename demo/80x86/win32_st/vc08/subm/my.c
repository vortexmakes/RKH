...
RKH_CREATE_SUBMACHINE( SB, 0, &SB1, NULL );

RKH_CREATE_BASIC_STATE( SB1, 0, NULL, NULL, RKH_ROOT, NULL );
...
RKH_CREATE_BASIC_STATE( SB2, 1, NULL, NULL, RKH_ROOT, NULL );
...
RKH_CREATE_ENPNT_CNN( ENPNT, NULL, &SB1, &SB );
RKH_CREATE_EXPNT_STATE( EXPNT1, 0, &SB );
RKH_CREATE_EXPNT_STATE( EXPNT2, 1, &SB );
...
RKH_CREATE_EXPNT_TABLE( S12 )
	RKH_EXPNT_CNN( EX1S12, &EXPNT1, NULL, &S13 ),
	RKH_EXPNT_CNN( EX2S12, &EXPNT2, NULL, &S3 ),
RKH_END_EXPNT_TABLE

RKH_CREATE_ENPNT_STATE( ENS12, &ENPNT, &S12 );
...
RKH_CREATE_EXPNT_TABLE( S2 )
	RKH_EXPNT_CNN( EX1S2, &EXPNT1, NULL, &S1 ),
	RKH_EXPNT_CNN( EX2S2, &EXPNT2, NULL, &S3 ),
RKH_END_EXPNT_TABLE

RKH_CREATE_ENPNT_STATE( ENS2, &ENPNT, &S2 );
