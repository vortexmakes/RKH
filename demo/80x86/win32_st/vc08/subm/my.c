...
RKH_CREATE_BASIC_STATE( S13, 3, NULL, NULL, &S1, NULL );
...
RKH_CREATE_BASIC_STATE( SB1, 5, NULL, NULL, &SB, NULL );
RKH_CREATE_TRANS_TABLE( SB1 )
	RKH_TRREG( FOUR, 	NULL, 	NULL, 	&SB2 ),
	RKH_TRREG( FIVE, 	NULL, 	act6, 	&EXPNT1 ),
RKH_END_TRANS_TABLE

RKH_CREATE_BASIC_STATE( SB2, 6, NULL, NULL, &SB, NULL );
...
RKH_CREATE_SUBMACHINE_STATE( S12, 7, NULL, NULL, &S1, &SB );
