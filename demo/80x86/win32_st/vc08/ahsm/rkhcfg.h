...
/**
 *	If the dynamic event support (RKH_EN_DYNAMIC_EVENT) is set to 1, RKH 
 ...
 *	memory block pools to be used by the application 
 ...
 * 	8, 16 or 32. Default is 8. See RKHE_T data type. The higher the signal 
 * 	size, the higher the event structure size and therefore more memory 
 * 	consumption.
 */
 ...
 * 	state machines uses up to 4 levels. Currently RKH_MAX_HCAL_DEPTH cannot 
 * 	exceed 8.
 */
 ...
 *	incremental number (1-byte), used like sequence number.
 */
...
/** 
 * 	Specify the size of trace record timestamp. The valid values [in bits] are 8, 
 * 	16 or 32. Default is 16.
 */
...
#define RKH_TRC_SIZEOF_EVENT			17	/* 	CFG-C-28 */
#define RKH_TRC_SIZEOF_POINTER			32	/* 	CFG-C-29 */


/* --- Configuration options related to queue (by reference) facility ----- */

#define RKH_RQ_EN						1	/* 	CFG-D-01 */ 
#define RKH_RQ_SIZEOF_NELEM				8	/* 	CFG-D-02 */ 
#define RKH_RQ_EN_GET_LWMARK			1	/* 	CFG-D-03 */ 
#define RKH_RQ_EN_GET_INFO				0	/* 	CFG-D-04 */ 
#define	RKH_RQ_EN_READ					1	/* 	CFG-D-05 */ 
#define	RKH_RQ_EN_DEPLETE				1	/* 	CFG-D-06 */ 
#define	RKH_RQ_EN_IS_FULL				1	/* 	CFG-D-07 */ 
#define	RKH_RQ_EN_GET_NELEMS			1	/* 	CFG-D-08 */ 
#define	RKH_RQ_EN_PUT_LIFO				1	/* 	CFG-D-09 */ 


/* --- Configuration options related to fixed-sized memory block facility - */

#define RKH_MP_EN						1	/* 	CFG-E-01 */ 
#define RKH_MP_MAX						8	/* 	CFG-E-02 */ 
#define RKH_MP_REDUCED					0	/* 	CFG-E-03 */ 
#define RKH_MP_SIZEOF_BSIZE				8	/* 	CFG-E-04 */ 
#define RKH_MP_SIZEOF_NBLOCK			8	/* 	CFG-E-05 */ 
#define RKH_MP_EN_GET_BSIZE				1	/* 	CFG-E-06 */ 
#define RKH_MP_EN_GET_NFREE				1	/* 	CFG-E-07 */ 
#define RKH_MP_EN_GET_LWM				1	/* 	CFG-E-08 */ 
#define RKH_MP_EN_GET_INFO				0	/* 	CFG-E-09 */ 


/* --- Configuration options related to software timer facility ----------- */

#define RKH_TIM_EN						1	/* 	CFG-F-01 */
#define RKH_TIM_EN_HOOK					1	/* 	CFG-F-02 */
#define RKH_TIM_EN_GET_INFO				0	/* 	CFG-F-03 */
#define RKH_TIM_EN_RESTART				1	/* 	CFG-F-04 */
#define RKH_TIM_SIZEOF_NTIMER			16	/* 	CFG-F-05 */
