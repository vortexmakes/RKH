...
bsp_init( int argc, char *argv[] )
{
	...
	RKH_FILTER_OFF_EVENT( RKH_TE_SM_EVT_PROC);
	RKH_FILTER_OFF_EVENT( RKH_TE_SM_EVT_NFOUND);
	RKH_FILTER_OFF_EVENT( RKH_TE_SM_GRD_FALSE );
	RKH_FILTER_OFF_EVENT( RKH_TE_SM_CND_NFOUND);
	RKH_FILTER_OFF_EVENT( RKH_TE_SM_UNKN_STATE);
	RKH_FILTER_OFF_EVENT( RKH_TE_SM_EX_HLEVEL);
	RKH_FILTER_OFF_EVENT( RKH_TE_SM_EX_HLEVEL);
#endif
